...
public class LoginTest {
    public static void main(String args[]) {
        ...
        try {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\srika\\Downloads\\chromedriver-win32 (1)\\chromedriver-win32\\chromedriver.exe");
            ...
            if (products.size() > 0) {
                ...
                if (currentUrll.equals(productDetailsUrl)) {
